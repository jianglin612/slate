      ...
      <div className="w-full max-w-4xl">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <h1 className="text-4xl font-bold text-white mb-4">Slate</h1>
            <p className="text-xl text-slate-300 mb-6">
              AI-powered task reporting for busy professionals
            </p>
            <p className="text-slate-400 mb-8">
              Slate automatically extracts tasks and action items from your emails and calendar events,
              helping you create professional weekly reports in minutes instead of hours.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-white font-medium">Email & Calendar Sync</h3>
                  <p className="text-sm text-slate-400">
                    Connect your Gmail or Outlook to automatically import emails and calendar events
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="text-2xl">🤖</div>
                <div>
                  <h3 className="text-white font-medium">AI Task Extraction</h3>
                  <p className="text-sm text-slate-400">
                    Our AI identifies tasks, deadlines, and collaborators from your communications
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="text-2xl">📤</div>
                <div>
                  <h3 className="text-white font-medium">Easy Report Sharing</h3>
                  <p className="text-sm text-slate-400">
                    Generate and share professional reports with your team or manager
                  </p>
                </div>
              </div>
            </div>
